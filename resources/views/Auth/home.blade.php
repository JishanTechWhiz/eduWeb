...
@section('content')
    <main>
        ...
        {{-- <header id="header"> --}}
        <!-- Notification area -->
        {{-- <div id="notification" class="notification">{{ session()->get('fail') }}</div> --}}
        {{-- </header> --}}

        @if (session()->has('success'))
            <div id="notification" class="notificationGreen">{{ session()->get('success') }}</div>
        @endif
        @if (session()->has('fail'))
            <div id="notification" class="notificationRed">{{ session()->get('fail') }}</div>
        @endif
        <article>
            ...
            <section class="section hero has-bg-image" id="home" aria-label="home"
                style="background-image: url('{{ url('/fronted/images/hero-bg.svg') }}')">
                <div class="container">
                    ...
                    <div class="hero-content">
                        ...
                        <a href="{{url('/course')}}" class="btn has-before">
                    ...
                    <figure class="hero-banner">
                        ...
                        <div class="img-holder one" style="--width: 270; --height: 300;">
                            <img src="{{ url('/fronted/images/hero-banner-1.jpg') }}" width="270" height="300"
                                alt="hero banner" class="img-cover">
                        </div>

                        <div class="img-holder two" style="--width: 240; --height: 370;">
                            <img src="{{ url('/fronted/images/hero-banner-2.jpg') }}" width="240" height="370"
                                alt="hero banner" class="img-cover">
                        </div>

                        <img src="{{ url('/fronted/images/hero-shape-1.svg') }}" width="380" height="190"
                            alt="" class="shape hero-shape-1">

                        <img src="{{ url('/fronted/images/hero-shape-2.png') }}" width="622" height="551"
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="category-card" style="--color: 170, 75%, 41%">
                                ...
                                <div class="card-icon">
                                    <img src="{{ url('/fronted/images/category-1.svg') }}" width="40" height="40"
                        ...
                        <li>
                            <div class="category-card" style="--color: 351, 83%, 61%">
                                ...
                                <div class="card-icon">
                                    <img src="{{ url('/fronted/images/category-2.svg') }}" width="40" height="40"
                        ...
                        <li>
                            <div class="category-card" style="--color: 229, 75%, 58%">
                                ...
                                <div class="card-icon">
                                    <img src="{{ url('/fronted/images/category-3.svg') }}" width="40" height="40"
                        ...
                        <li>
                            <div class="category-card" style="--color: 42, 94%, 55%">
                                ...
                                <div class="card-icon">
                                    <img src="{{ url('/fronted/images/category-4.svg') }}" width="40" height="40"
                        ...
                        <li>
                            <div class="course-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <h3 class="h3">
                                        <a href="#" class="card-title">Build Responsive Real- World Websites with
                                            HTML and CSS</a>
                                    </h3>
            ...
            <section class="video has-bg-image" aria-label="video"
                style="background-image: url('{{ url('/fronted/images/video-bg.png') }}')">
                <div class="container">

                    <div class="video-card">

                        <div class="video-banner img-holder has-after" style="--width: ; --height: ;">
                            <img src="{{ url('/fronted/images/video-banner.jpg') }}" width="970" height="550"
                                loading="lazy" alt="video banner" class="img-cover">
                        ...
                        <img src="{{ url('/fronted/images/video-shape-1.png') }}" width="1089" height="605"
                            loading="lazy" alt="" class="shape video-shape-1">

                        <img src="{{ url('/fronted/images/video-shape-2.png') }}" width="158" height="174"
                            loading="lazy" alt="" class="shape video-shape-2">
            ...
            <section class="section blog has-bg-image" id="blog" aria-label="blog"
                style="background-image: url('{{ url('/fronted/images/blog-bg.svg') }}')">
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="{{ url('/fronted/images/blog-1.jpg') }}" width="370" height="370"
                                        loading="lazy" alt="Become A Better Blogger: Content Planning" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="{{ url('/fronted/images/blog-2.jpg') }}" width="370" height="370"
                                        loading="lazy" alt="Become A Better Blogger: Content Planning" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                                    <img src="{{ url('/fronted/images/blog-3.jpg') }}" width="370" height="370"
                                        loading="lazy" alt="Become A Better Blogger: Content Planning" class="img-cover">
                                </figure>
                    ...
                    <a href="{{ url('/blog') }}" class="btn has-before myBtn">
                        <span class="span">Browse more Blogs</span>

                        <ion-icon name="arrow-forward-outline" aria-hidden="true"></ion-icon>
                    </a>

                    <img src="{{ url('/fronted/images/blog-shape.png') }}" width="186" height="186" loading="lazy"
